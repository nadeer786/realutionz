...
export const AppPropertyData = {
  ...
  Testimonials: [
    {
      id: 1,
      detail:
        "Great response from the team. timely action  . much appreciated.",
      name: "Jobin Vayalil",
    },
  ],
  WhatWeDo: [
    {
      ...
      img: <Home />,
      details: "The best and most reasonable residential property.",
    },
    {
      title: "Commercial Property",
      img: <DollarSign />,
      details: "We help acquire commercial property at the best location.",
    },
    {
      title: "Industrial Property",
      img: <Settings />,
      details:
        "Will suggest an industrial property for your profitable business.",
    },
    {
      title: "Property & Asset",
      img: <Bell />,
      details: "Rent and lease the property and assets with trust.",
    },
  ],
  PropertyServices: [
    {
  ...
  Brand1: [
    "/assets/images/brand/rera-logo.png",
