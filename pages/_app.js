  ...
  useEffect(() => {
    router.events.on("routeChangeComplete", () => {
      document.documentElement.style.setProperty(
        "--theme-default",
        ConfigDB.PrimaryColor ? ConfigDB.PrimaryColor : "#ff5c41"
      );
      document.documentElement.style.setProperty(
        "--theme-default2",
        ConfigDB.SecondaryColor ? ConfigDB.SecondaryColor : "#ff8c41"
      );
    });
    document.documentElement.style.setProperty(
      "--theme-default",
      ...
      <Provider store={store}>
        <>
          ...
          {/* <div>
            <WhatsAppWidget
              CompanyIcon="icon"
              phoneNumber="+91 9747676079"
              companyName="Realutionz Properties"
            />
          </div> */}
        </>
      </Provider>
