      ...
      <div className="comment-box">
        ...
        <div className="media inner-comment">
          ...
          <div className="media-body">
            ...
            <div className="comment-detail">
              <p className="font-roboto">
                For example, connected residences might be owned by a single
                entity and leased out, Residences can be classified by and how
                they are connected to neighbouring residences and land.
          ...
          <div className="media-body">
            ...
            <div className="comment-detail">
              <p className="font-roboto">
                ...
                by a single entity and leased out, Residences can be classified
                by and how they are connected to neighbouring residences and
                land.
              </p>
            </div>
            <div className="text-end">
